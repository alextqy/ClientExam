...
// ========================================================================= teacher side =========================================================================
  ...
  void teacherResetExamQuestionData({required int id}) async {
    operationStatus.value = OperationStatus.loading;
    try {
      result = await teacherApi.teacherResetExamQuestionData(id: id);
      if (result.state == true) {
        operationStatus.value = OperationStatus.success;
      } else {
        operationStatus.value = OperationStatus.failure;
  ...
  void teacherExamInfoDisabled({required int id}) async {
    operationStatus.value = OperationStatus.loading;
    try {
      result = await teacherApi.teacherExamInfoDisabled(id: id);
      if (result.state == true) {
        operationStatus.value = OperationStatus.success;
      } else {
        operationStatus.value = OperationStatus.failure;
  ...
  void teacherGradeTheExam({required int id}) async {
    operationStatus.value = OperationStatus.loading;
    try {
      result = await teacherApi.teacherGradeTheExam(id: id);
      if (result.state == true) {
        operationStatus.value = OperationStatus.success;
      } else {
        operationStatus.value = OperationStatus.failure;
  ...
  void teacherExamInfoSuspend({required int id}) async {
    operationStatus.value = OperationStatus.loading;
    try {
      result = await teacherApi.teacherExamInfoSuspend(id: id);
      if (result.state == true) {
        operationStatus.value = OperationStatus.success;
      } else {
        operationStatus.value = OperationStatus.failure;
