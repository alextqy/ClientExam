...
from StyleSheet.Manager.ExamInfoHistoryStyleSheet import *
...
class ExamInfoHistoryFrameTemplate(BaseTemplate, QFrame):
    ...
    def __init__(self):
        super().__init__()
        self.ExamInfoHistoryStyleSheet = ExamInfoHistoryStyleSheet()
        ...
        self.PageInput.setStyleSheet(self.ExamInfoHistoryStyleSheet.InputBox())  # 设置样式
        ...
        self.RowsInput.setStyleSheet(self.ExamInfoHistoryStyleSheet.InputBox())  # 设置样式
        ...
        self.SearchInput.setStyleSheet(self.ExamInfoHistoryStyleSheet.InputBox())  # 设置样式
        ...
        self.ConfirmButton.setStyleSheet(self.ExamInfoHistoryStyleSheet.Button())  # 设置样式
        ...
        self.PreviousPageButton.setStyleSheet(self.ExamInfoHistoryStyleSheet.Button())  # 设置样式
        ...
        self.NextPageButton.setStyleSheet(self.ExamInfoHistoryStyleSheet.Button())  # 设置样式
        ...
        self.RefreshButton.setStyleSheet(self.ExamInfoHistoryStyleSheet.Button())  # 设置样式
    ...
    def TreeDataInit(self):
        ...
        Result = self.ExamInfoHistoryController.ExamInfoHistoryList(Page, PageSize, Stext, ExamState, ExamType, Pass)
        ...
        if Result['State'] != True:
            ...
            self.ExamInfoTree.setStyleSheet(self.ExamInfoHistoryStyleSheet.TreeWidget())  # 设置样式
    ...
    def RightContextMenuExec(self, pos):
        ...
        self.TreeMenu.setStyleSheet(self.ExamInfoHistoryStyleSheet.TreeMenu())  # 设置样式
    ...
    def InfoWindow(self, Item):
        ...
        self.ExamInfoDetailsView.setStyleSheet(self.ExamInfoHistoryStyleSheet.Dialog())  # 设置样式
        ...
        ExamNoInput.setStyleSheet(self.ExamInfoHistoryStyleSheet.InputBox())  # 设置样式
        ...
        ExamineeNameInput.setStyleSheet(self.ExamInfoHistoryStyleSheet.InputBox())  # 设置样式
        ...
        ExamineeNoInput.setStyleSheet(self.ExamInfoHistoryStyleSheet.InputBox())  # 设置样式
        ...
        UpdateTimeInput.setStyleSheet(self.ExamInfoHistoryStyleSheet.InputBox())  # 设置样式
