...
from StyleSheet.Manager.ExamInfoStyleSheet import *
...
class ExamInfoFrameTemplate(BaseTemplate, QFrame):
    ...
    def __init__(self):
        ...
        self.setStyleSheet(self.ExamInfoStyleSheet.BaseStyleSheet())  # 设置样式
        ...
        self.Headline.setStyleSheet(self.ExamInfoStyleSheet.Headline())  # 设置样式
        ...
        self.CurrentPage.setStyleSheet(self.ExamInfoStyleSheet.CurrentPage())  # 设置样式
        ...
        self.TotalPage.setStyleSheet(self.ExamInfoStyleSheet.CurrentPage())  # 设置样式
        ...
        self.PageInput.setStyleSheet(self.ExamInfoStyleSheet.InputBox())  # 设置样式
        ...
        self.RowsInput.setStyleSheet(self.ExamInfoStyleSheet.InputBox())  # 设置样式
        ...
        self.SearchInput.setStyleSheet(self.ExamInfoStyleSheet.InputBox())  # 设置样式
        ...
        self.ConfirmButton.setStyleSheet(self.ExamInfoStyleSheet.Button())  # 设置样式
        ...
        self.PreviousPageButton.setStyleSheet(self.ExamInfoStyleSheet.Button())  # 设置样式
        ...
        self.NextPageButton.setStyleSheet(self.ExamInfoStyleSheet.Button())  # 设置样式
        ...
        self.NewExamInfoButton.setStyleSheet(self.ExamInfoStyleSheet.Button())  # 设置样式
        ...
        self.ImportRegistrationButton.setStyleSheet(self.ExamInfoStyleSheet.Button())  # 设置样式
        ...
        self.DemoButton.setStyleSheet(self.ExamInfoStyleSheet.Button())  # 设置样式
        ...
        self.RefreshButton.setStyleSheet(self.ExamInfoStyleSheet.Button())  # 设置样式
    ...
    def TreeDataInit(self):
        ...
        if Result['State'] != True:
            ...
            self.ExamInfoTree.setStyleSheet(self.ExamInfoStyleSheet.TreeWidget())  # 设置样式
    ...
    def RightContextMenuExec(self, pos):
        ...
        self.TreeMenu.setStyleSheet(self.ExamInfoStyleSheet.TreeMenu())  # 设置样式
    ...
    def InfoWindow(self, Item):
        ...
        self.ExamInfoDetailsView.setStyleSheet(self.ExamInfoStyleSheet.Dialog())  # 设置样式
        ...
        ExamNoInput.setStyleSheet(self.ExamInfoStyleSheet.InputBox())  # 设置样式
        ...
        ExamineeNameInput.setStyleSheet(self.ExamInfoStyleSheet.InputBox())  # 设置样式
        ...
        ExamineeNoInput.setStyleSheet(self.ExamInfoStyleSheet.InputBox())  # 设置样式
        ...
        UpdateTimeInput.setStyleSheet(self.ExamInfoStyleSheet.InputBox())  # 设置样式
    ...
    def NewExamInfoWindow(self):
        ...
        if CheckSubjects['State'] != True and len(CheckSubjects['Data']) == 0:
            ...
            self.NewExamInfoView.setStyleSheet(self.ExamInfoStyleSheet.Dialog())  # 设置样式
            ...
            self.SubjectSelectButton.setStyleSheet(self.ExamInfoStyleSheet.Button())  # 设置样式
            ...
            self.ExamineeSelectButton.setStyleSheet(self.ExamInfoStyleSheet.Button())  # 设置样式
            ...
            AddButton.setStyleSheet(self.ExamInfoStyleSheet.Button())  # 设置样式
