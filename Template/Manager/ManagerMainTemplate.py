...
class ManagerMainTemplate(BaseTemplate, QDialog):
    ...
    def InitMenu(self):
        ...
        self.TeacherButton.setFixedSize(ButtonWidth, ButtonHeight)  # 设置固定大小
        ...
        self.ClassButton.setFixedSize(ButtonWidth, ButtonHeight)  # 设置固定大小
        ...
        self.ExamineeButton.setFixedSize(ButtonWidth, ButtonHeight)  # 设置固定大小
        ...
        self.SubjectButton.setFixedSize(ButtonWidth, ButtonHeight)  # 设置固定大小
        ...
        self.KnowledgePointButton.setFixedSize(ButtonWidth, ButtonHeight)  # 设置固定大小
        ...
        self.HeadlineButton.setFixedSize(ButtonWidth, ButtonHeight)  # 设置固定大小
        ...
        self.TestQuestionButton.setFixedSize(ButtonWidth, ButtonHeight)  # 设置固定大小
        ...
        self.TestPaperButton.setFixedSize(ButtonWidth, ButtonHeight)  # 设置固定大小
        ...
        self.TestPaperRulesButton.setFixedSize(ButtonWidth, ButtonHeight)  # 设置固定大小
        ...
        self.ExamLogButton.setFixedSize(ButtonWidth, ButtonHeight)  # 设置固定大小
